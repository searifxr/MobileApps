...
class TriviaGame {
    static func getCategories() -> [String] {
        return Array(getQuestionDB().keys).sorted()
    }
    ...
    static func getQuestionDB() -> [String : [Trivia]] {
        ...
        Trivia(q: "The Principality of Sealand is an unrecognized micronation off the coast of what country?", correct: "The United Kingdom", incorrect: ["Japan", "Australia", "Argentina"]),
